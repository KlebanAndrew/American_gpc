			...
			<header>
					...
					<div class="mainslogan">
						...
						<div class="languagedrpdwm">
							<dl id="sample" class="dropdown">
								...
								<dd>
									<ul class="lang_href" lang="eng">
										<li><a class="lang_href" lang="eng" href="#">United States<img class="flag" src="css/flagimg/us.png" alt="" /><span class="value">US</span></a></li>
										<li><a class="lang_href" lang="ua" href="#">Ukraine<img class="flag" src="css/flagimg/ue.png" alt="" /><span class="value">UE</span></a></li>
										<li><a class="lang_href" lang="ru" href="./ru">Belarus<img class="flag" src="css/flagimg/by.png" alt="" /><span class="value">BY</span></a></li>
				...
				<div class="menumain">
					<div>
						...
						<li class="menuli"><a href="./eng" class="menulink">HOME</a></li>
						<li class="menuli"><a href="./eng" class="menulink">PRODUCTS</a></li>
						<li class="menuli"><a href="./eng" class="menulink">AFFILIATES</a></li>
						<li class="menuli"><a href="./eng/about.php" class="menulink">ABOUT US</a></li>
						</ul>
					</div>
				</div>
			</header>
